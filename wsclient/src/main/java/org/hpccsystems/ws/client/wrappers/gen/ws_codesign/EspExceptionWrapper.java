 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException
...
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException();
