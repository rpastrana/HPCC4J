package org.hpccsystems.ws.client.wrappers.gen.ws_codesign;
 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.ws_codesign
 * Service version: 1.1
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException[this.local_exception.size()];
