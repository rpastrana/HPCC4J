...
public class DFURecordTypeInfoResponse  implements java.io.Serializable {
    private java.lang.String jsonInfo;

    private byte[] binInfo;

    public DFURecordTypeInfoResponse() {
    }
    ...
    /**
     * Gets the jsonInfo value for this DFURecordTypeInfoResponse.
     * 
     * @return jsonInfo
     */
    ...
    /**
     * Sets the jsonInfo value for this DFURecordTypeInfoResponse.
     * 
     * @param jsonInfo
     */
    ...
    /**
     * Gets the binInfo value for this DFURecordTypeInfoResponse.
     * 
     * @return binInfo
     */
    ...
    /**
     * Sets the binInfo value for this DFURecordTypeInfoResponse.
     * 
     * @param binInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DFURecordTypeInfoResponse)) return false;
        DFURecordTypeInfoResponse other = (DFURecordTypeInfoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DFURecordTypeInfoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", ">DFURecordTypeInfoResponse"));
