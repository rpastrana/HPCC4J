 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault
...
public class EspSoapFaultWrapper
{
    ...
    public EspSoapFaultWrapper( org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault espsoapfault)
    {
        copy( espsoapfault );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault raw = new org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspSoapFault();
