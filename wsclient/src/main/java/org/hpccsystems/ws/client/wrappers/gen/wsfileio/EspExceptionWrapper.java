 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException
...
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.EspException();
