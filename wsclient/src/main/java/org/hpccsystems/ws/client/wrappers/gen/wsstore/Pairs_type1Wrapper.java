 ...
 * Class name: Pairs_type1Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1
...
public class Pairs_type1Wrapper
{
    ...
    public Pairs_type1Wrapper( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1 pairs_type1)
    {
        copy( pairs_type1 );
    }
    public Pairs_type1Wrapper( List<KVPairWrapper> _pair )
    {
        this.local_pair = _pair;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "Pairs_type1Wrapper [" + "pair = " + local_pair + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1 raw = new org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1();
