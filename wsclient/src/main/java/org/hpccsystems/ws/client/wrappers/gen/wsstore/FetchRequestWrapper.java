 ...
 * Class name: FetchRequestWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsstore
 * Service version: 1.02
 */
public class FetchRequestWrapper
{
    ...
    public FetchRequestWrapper() {}

    public FetchRequestWrapper( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest fetchrequest)
    {
        copy( fetchrequest );
    }
    public FetchRequestWrapper( String _storeName, String _namespace, String _key, boolean _userSpecific )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "FetchRequestWrapper [" + "storeName = " + local_storeName + ", " + "namespace = " + local_namespace + ", " + "key = " + local_key + ", " + "userSpecific = " + local_userSpecific + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest raw = new org.hpccsystems.ws.client.gen.axis2.wsstore.latest.FetchRequest();
