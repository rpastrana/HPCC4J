 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException
...
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wsstore.latest.EspException();
