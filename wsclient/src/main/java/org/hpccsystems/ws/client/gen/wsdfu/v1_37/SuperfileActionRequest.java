...
public class SuperfileActionRequest  implements java.io.Serializable {
    ...
    private java.lang.Boolean removeSuperfile;
    ...
    public SuperfileActionRequest(
           ...
           java.lang.Boolean removeSuperfile) {
           this.action = action;
           this.superfile = superfile;
           this.subfiles = subfiles;
           this.before = before;
           this.delete = delete;
           this.removeSuperfile = removeSuperfile;
    }
    ...
    /**
     * Gets the removeSuperfile value for this SuperfileActionRequest.
     * 
     * @return removeSuperfile
     */
    public java.lang.Boolean getRemoveSuperfile() {
        return removeSuperfile;
    }


    /**
     * Sets the removeSuperfile value for this SuperfileActionRequest.
     * 
     * @param removeSuperfile
     */
    public void setRemoveSuperfile(java.lang.Boolean removeSuperfile) {
        this.removeSuperfile = removeSuperfile;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.removeSuperfile==null && other.getRemoveSuperfile()==null) || 
             (this.removeSuperfile!=null &&
              this.removeSuperfile.equals(other.getRemoveSuperfile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("removeSuperfile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "removeSuperfile"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
