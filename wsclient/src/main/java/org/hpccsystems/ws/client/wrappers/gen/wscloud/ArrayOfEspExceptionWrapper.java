 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException
...
public class ArrayOfEspExceptionWrapper
{
    ...
    public ArrayOfEspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException arrayofespexception)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wscloud.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wscloud.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wscloud.latest.EspException[this.local_exception.size()];
